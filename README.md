...
**F-16 Control Surfaces Constraints**

- **δₜₕ**: Throttle (0 to 1)
  - Throttle is a dimensionless control input representing the power level of the engine. It ranges from 0 (idle) to 1 (full throttle).

- **δₐ**: Aileron angle (±21.5°)
  - Ailerons are used for roll control. The maximum deflection is ±21.5 degrees, where positive values represent left wing down and negative values represent right wing down.

- **δₑ**: Elevator angle (±30°)
  - The elevator controls the pitch of the aircraft. The maximum deflection is ±30 degrees, where positive values represent nose up and negative values represent nose down.

- **δᵣ**: Rudder angle (±25°)
  - The rudder controls yaw. The maximum deflection is ±25 degrees, where positive values represent yawing to the right and negative values represent yawing to the left.

### **Equations of Motion**

![Dynamics](image/f16_dynamics.png)
